...
public:
    ...
    //my code
    virtual void left_redistribute(TreePtr tree_ptr){}
    virtual void left_merge(TreePtr tree_ptr,Key key){}
    virtual void right_redistribute(TreePtr tree_ptr){}
    virtual void right_merge(TreePtr tree_ptr){}
    //my code
